...
const HojeView           = lazy(() => import('./components/HojeView'))
                    ...
                    <Route path="/hoje" element={
                      <PageTransition>
                        <HojeView
                          ...
                          getNextAction={progress.getNextAction}
                          getReviewQueue={progress.getReviewQueue}
                          getRiskBySubject={progress.getRiskBySubject}
                          getMistakeCards={progress.getMistakeCards}
                          setCurMes={setCurMes}
